  ...
  return (
    <>
      <header className={`sticky top-0 z-50 bg-white transition-shadow duration-300 ${isScrolled ? 'shadow-md' : ''}`} role="banner">
        ...
        {/* TOP STRIP - ATTRACTIVE VERSION */}
<div className="hidden md:block bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 border-b border-blue-600/30">
  <div className="w-full px-4 sm:px-6 lg:px-12 flex items-center justify-between py-2">
    <div className="flex items-center gap-2">
      <button className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold transition-all rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/10" style={{ color: '#fff' }}>
        ...
        Scheduled
        <span className="ml-1 text-[8px] font-bold uppercase bg-white/20 px-1.5 py-0.5 rounded-full">New</span>
      </button>
      <button className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold transition-all rounded-full bg-orange-500/20 hover:bg-orange-500/30 backdrop-blur-sm border border-orange-400/20 text-orange-100">
        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
        </svg>
        Express
        <span className="ml-1 text-[8px] font-bold bg-orange-500 px-1.5 py-0.5 rounded-full text-white">⚡</span>
      </button>
      ...
      <span className="flex items-center gap-1.5 text-xs text-white font-bold">
        <span className="relative flex h-2 w-2">
         ...
         Free delivery on all orders {/*over KES 5,000 */}
      </span>
    </div>
    <div className="flex items-center gap-3">
      <span className="text-[10px] text-white font-bold tracking-widest uppercase flex items-center gap-1.5">
        <span className="inline-block w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse"></span>
        Open 24/7
      </span>
      <div className="h-4 w-px bg-white/10"></div>
      <Link href="/help" className="text-xs text-white hover:text-white transition-colors font-medium">
        Help Center
      </Link>
      <div className="h-4 w-px bg-white/10"></div>
      <Link href="/contact" className="text-xs text-white hover:text-white transition-colors font-medium">
        Contact
      </Link>
    </div>
  </div>
