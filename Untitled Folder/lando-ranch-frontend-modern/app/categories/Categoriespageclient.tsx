...
// app/categories/CategoriesPageClient.tsx
// Your existing CategoriesPage UI — 100% unchanged.
// Renamed so that categories/page.tsx can be a server component (needed for generateMetadata).
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-[#004E9A] overflow-hidden">
        ...
        <div className="relative mx-auto px-4 sm:px-6 lg:px-12 py-12 md:py-16">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-white leading-tight mb-4">Shop by Category</h2>
